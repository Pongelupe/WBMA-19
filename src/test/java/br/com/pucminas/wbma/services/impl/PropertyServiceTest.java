package br.com.pucminas.wbma.services.impl;
...
import br.com.pucminas.wbma.service.impl.PropertyService;

public class PropertyServiceTest {

	private PropertyService propertyService;
	private static final String WBMA_PROPERTIES_TEST = "wbma.properties";

	@Before
	public void setUp() throws Exception {
		propertyService = new PropertyService();
		InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream(WBMA_PROPERTIES_TEST);
	...
	public void testSetPropEager() throws Exception {
		...
		FileOutputStream fileOutputStream = new FileOutputStream(
				this.getClass().getClassLoader().getResource(WBMA_PROPERTIES_TEST).getFile());
